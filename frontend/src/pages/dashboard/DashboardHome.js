    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
        <h3 className="text-lg font-semibold text-neutral-900 mb-4 flex items-center">
          ...
          Nearby Donors & Hospitals
        </h3>
        <p className="text-sm text-neutral-600 mb-4">
          Find blood donors and medical facilities in your area
        </p>
        <MapComponent
          center={[31.5497, 74.3436]} // Lahore coordinates
          zoom={12}
          height="400px"
          markers={[
            {
            ...
            },
            {
              ...
              title: "Lahore General Hospital",
              description: "Blood bank available",
              bloodType: "All Types"
            },
            {
              position: [31.5597, 74.3036],
              title: "Services Hospital",
              description: "Emergency blood services",
              bloodType: "All Types"
            },
            {
              position: [31.5797, 74.3836],
              title: "Donor Center - Gulberg",
              description: "Regular blood donation camp",
              bloodType: "A+, B+, O+"
            }
          ]}
        />
